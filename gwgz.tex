...
\hbox to\z@{\hskip0.1zw\vrule\@width\dimexpr\wd\z@-0.2zw \@depth\z@ \@height.4\p@\hss}%
\box\z@
\fi\fi}
\makeatother
...
初，\hidarikasen{鄭武公}娶于\hidarinijusen{申}\footnote{注一}，曰\hidarikasen{武姜}，生\hidarikasen{莊公}及\hidarikasen{共叔段}。\hidarikasen{莊公}寤生，驚\hidarikasen{姜氏}，故名曰\hidarikasen{寤生}，遂惡之。愛\hidarikasen{共叔段}，欲立之，亟請於\hidarikasen{武公}，\hidarikasen{公}弗許。

及\hidarikasen{莊公}即位，為之請\hidarinijusen{制}。\hidarikasen{公}曰：「\hidarinijusen{制}，巖邑也。\hidarikasen{虢叔}死焉，佗邑唯命\footnote{再注}。」請京，使居之，謂之\hidarikasen{京城大叔}。

\hidarikasen{祭仲}曰：「都城過百雉，國之害也。先王之制：大都，不過參國之一；中，五之一；小，九之一。今京不度，非制也，君將不堪。」\hidarikasen{公}曰：「\hidarikasen{姜氏}欲之，焉辟害？」對曰：「\hidarikasen{姜氏}何厭之有？不如早為之所，無使滋蔓！蔓，難圖也。蔓草猶不可除，況君之寵弟乎？」\hidarikasen{公}曰：「多行不義，必自斃，子姑待之！」

既而\hidarikasen{大叔}命\hidarinijusen{西鄙}、\hidarinijusen{北鄙}貳於己。\hidarikasen{公子呂}曰：「國不堪貳，君將若之何？欲與\hidarikasen{大叔}，臣請事之；若弗與，則請除之，無生民心。」\hidarikasen{公}曰：「無庸，將自及。」
